...
def preProcessingData(data : str) -> list[str] | str | str :
      founded_lines = []
...
def main(text):
      founded_lines , APE , APM , trip_number = preProcessingData(text)
      ...
      avaliable_seats ,  back_trip.number_of_trip , back_trip.from_to_city , back_trip.date , APM , APE ]
